...
export default function EditMedicationPage() {
  ...
  const { medications, residents, updateMedication } = useData()
    ...
    return (
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Medication Not Found</h1>
          <Link href="/medications" className="text-xl text-purple-600 hover:underline">
            ← Back to Medications
          </Link>
        </div>
      </div>
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateMedication(medication.id, {
      ...formData,
      residentName: resident?.name || medication.residentName,
    })
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-xl text-gray-700">Update medication information</p>
      </div>
