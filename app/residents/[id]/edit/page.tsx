    ...
    return (
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Resident Not Found</h1>
          <Link href="/residents" className="text-xl text-happy-600 hover:underline">
            ← Back to Residents
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-xl text-gray-700">Update resident information</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-gradient-to-br from-white to-happy-50 border-4 border-happy-300 p-8 rounded-2xl shadow-xl">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-lg font-semibold text-gray-800 mb-2">Room Number</label>
              <input
                type="text"
                name="roomNumber"
          ...
          <div>
            <label className="block text-lg font-semibold text-gray-800 mb-2">Emergency Contact</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-lg font-semibold text-gray-800 mb-2">Medical Conditions</label>
            <textarea
          ...
          <div>
            <label className="block text-lg font-semibold text-gray-800 mb-2">Allergies</label>
            <textarea
              name="allergies"
